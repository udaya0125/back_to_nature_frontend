...
//     "Explore the best trekking destinations including Everest Base Camp, Annapurna, Hidden Lake, and more. Plan your Himalayan adventure now.";
...
//         <meta
//           property="og:title"
//           content="Trekking Adventures | Best Himalayan Treks in Nepal"
//         />
...
//               We couldn't find any trekking options at the moment.
//             </p>
//           </div>
//         )}
//       </section>
...
const TrekkingPage = () => {
  ...
  console.log("Fetched treks:", treks);
  ...
  const schemaData = {
    ...
    itemListElement: treks.map((trek, index) => ({
      ...
      url: `https://backtonatureadventure.com/trekkings/${trek.slug}`,
      name: trek.title,
      description: cleanDescription(trek.description),
    })),
  };
              ...
              <Link
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8">
                  <div className="text-white">
                    ...
                    <p className="text-base sm:text-lg text-white line-clamp-2 mb-6">
                      {cleanDescription(trek.description)}...
                    </p>
