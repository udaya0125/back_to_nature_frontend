...
const WesternUnion = () => {
  return (
    <section className="relative overflow-hidden bg-[#f8fafc] py-16 sm:py-20 lg:py-24">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-stretch gap-8 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10 lg:px-8">
          ...
          <div className="relative flex h-full flex-col justify-between gap-8 p-6 sm:p-8 lg:p-10">
            <div className="space-y-5 text-center sm:text-left">
              ...
              <div className="space-y-4">
                ...
                <p className="mx-auto max-w-2xl text-sm leading-7 text-white/80 sm:mx-0 sm:text-base">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/15 bg-white/10 p-5 backdrop-blur-sm">
                <div className="mb-3 flex items-center justify-center gap-3 text-[#facc15] sm:justify-start">
                  <ShieldCheck size={20} />
                  <p className="text-sm font-semibold uppercase tracking-[0.2em]">
                    Security First
                  </p>
                </div>
                <p className="text-center text-sm leading-7 text-white/80 sm:text-left">
        ...
        <div className="flex h-full flex-col justify-center space-y-6">
          ...
          <div className="space-y-4">
            {paymentSteps.map((step, index) => (
              <div
                key={step.title}
                className="flex flex-col items-center gap-4 rounded-[1.75rem] border border-slate-200 bg-white p-5 text-center shadow-[0_12px_40px_rgba(15,23,42,0.06)] transition-transform duration-300 hover:-translate-y-1 sm:flex-row sm:items-start sm:text-left"
              >
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {supportPoints.map((point) => (
                    <div key={point} className="flex items-start gap-3 text-left text-slate-700">
