...
const Tours = () => {
  ...
  const getImageUrl = (imageData) => {
    ...
    if (typeof imageData === 'string') {
      ...
      if (imageData.startsWith('tours/')) return `http://127.0.0.1:8000/storage/${imageData}`;
...
//               {/* Description */}
//               <div 
//                 className="text-gray-800 text-sm md:text-base mt-6 md:mt-8"
//                 dangerouslySetInnerHTML={{ __html: tour.description }}
//               />
...
//                     {activeDay === item.id && (
//                       <div 
//                         className="px-3 sm:px-4 md:px-6 pb-3 md:pb-4 pt-1 md:pt-2 bg-gray-50"
//                         dangerouslySetInnerHTML={{ __html: item.description }}
//                       />
//                     )}
//                   </div>
...
//                   </h3>
//                   <div 
//                     className="text-gray-500 space-y-1 md:space-y-2 list-disc pl-4 md:pl-5 text-sm md:text-base"
//                     dangerouslySetInnerHTML={{ __html: tour.includes }}
//                   />
//                 </div>
...
//                   <div 
//                     className="text-gray-500 space-y-1 md:space-y-2 list-disc pl-4 md:pl-5 text-sm md:text-base"
//                     dangerouslySetInnerHTML={{ __html: tour.excludes }}
//                   />
//                 </div>
...
//     Fancybox.close();
//   };
// }, [tour]); // re-bind when tour changes
